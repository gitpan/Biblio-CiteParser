...
B<Biblio::CiteParser> - citation parsing framework 

=head1 DESCRIPTION

Biblio::CiteParser provides generic methods for reference parsers. This
...
=item $cite_parser = Biblio::CiteParser-E<gt>new()
